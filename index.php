        ...
        <header class="main-header">
            <div class="container clearfix common-pad">
                <div class="row contact-head">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contact-row">
                        <div class="contact-detail">
                            ...
                            <a href="#" ><img class="add-user "src="images/icon/user(1).png" alt="" /></a>
                            <a href="#"><img class="index" src="images/icon/user(2).png" alt=""/></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row logo-section">
                    <div class="col-sm-4 col-xs-4  hidden-md hidden-lg hidden-sm visible-xs">
