    ...
    <body style="background-color: #FFF;">
                                    ...
                                    <div class="row verification-page-details resend-code hidden">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row view-number">
                                                ...
                                                <div  class="col-md-7 col-sm-7 col-xs-12 resend-contact-no"><span class="contact-number"> <?php echo $VISITOR->contact_number; ?></span></div>
                                            </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                if(width == 320) {
                    $('.country-list').css('width','184px');
                } else if (width > 320 && width < 576) {
                    $('.country-list').css('width','224px');
