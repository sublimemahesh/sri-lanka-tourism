...
<html lang="en">
    ...
    <head>
        ...
        <title>My Account || Edit Transport Photo || www.srilankatourism.travel</title>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="bottom-top">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="text" id="caption" name="caption" class="form-control" placeholder="Please Enter Title" value="<?php echo $TRANSPORTS_PHOTO->caption; ?>" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="file" id="image" class="form-control" value="<?php echo $TRANSPORTS_PHOTO->image_name; ?>"  name="image">
