        ...
        <div class="container">
            <div class="row footer-includes">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center footer-logo">
                    <a href="../"><img src="images/logo-intro.png" height="70px" alt=""></a>
                </div>
                ...
                <div class="fbottom text-center">
                    <a class="white-links" href="#">Terms</a><span>|</span>
                    <a class="white-links" href="#">Privacy</a><span>|</span>
                    <a class="white-links" href="#">Contact Us</a>
                </div>
            </div>
        </div>
    </footer>
