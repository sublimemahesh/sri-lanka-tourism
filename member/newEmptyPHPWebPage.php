...
<html lang="en">
    ...
    <body>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <p class="centered"><a href="http://blacktie.co/demo/dashgum/profile.html"><img src="assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
        ...
        <script src="../../../blacktie.co/demo/dashgum/assets/js/jjquery-1.8.3.min.html"></script>
