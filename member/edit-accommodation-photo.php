...
<html lang="en">
    ...
    <head>
        ...
        <title>My Account || Edit Accommodation Photo || www.srilankatourism.travel</title>
                    ...
                    <div class="container-fluid">
                        <div class="row  top-bott20"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"><i class="fa fa-pencil"></i> Edit Accommodation Photo</div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="bottom-top">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="text" id="caption" name="caption" class="form-control" placeholder="Please Enter Title" value="<?php echo $ACCOMODATION_PHOTO->caption; ?>" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="file" id="image" class="form-control" value="<?php echo $ACCOMODATION_PHOTO->image_name; ?>"  name="image">
                                                                    <img src="../upload/accommodation/<?php echo $ACCOMODATION_PHOTO->image_name; ?>" id="image" class="view-edit-img img img-responsive img-thumbnail" name="image" alt="old image">
                                                                </div>
                                                            </div>
