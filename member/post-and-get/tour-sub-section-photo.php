...
if (isset($_POST['create'])) {
    ...
    $TOUR_SUB_PHOTO->image_name = $imgName;

    $VALID->check($TOUR_SUB_PHOTO, [
...
if (isset($_POST['update'])) {
    ...
    $TOUR_SUB_PHOTO->image_name = $_POST['oldImageName'];
    $TOUR_SUB_PHOTO->caption = filter_input(INPUT_POST, 'caption');
...
if (isset($_POST['save-data'])) {
    ...
    foreach ($_POST['sort'] as $key => $img) {
        ...
        $TOUR_SUB_PHOTO = TourSubSectionPhoto::arrange($key, $img);
