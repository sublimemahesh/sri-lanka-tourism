                                ...
                                <div class="row">
                                    <div class="top-bott50">
                                        <div class="bottom-top">
                                            ...
                                            <input type="hidden" id="transport" value="<?php echo $TRANSPORT->id; ?>" name="transport"/>
                                            <input type="hidden" id="date_time_booked" value="<?php echo $now; ?>" name="date_time_booked"/>
                                            <input type="submit" name="book-rent-a-car" value="Book Now" class="btn btn-info center-block">
                                        </div>
                                    </div> 
                                </div>
                            </form>
