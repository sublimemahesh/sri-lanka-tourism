...
class RentACar {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`transport`,`visitor`,`date`,`time`,`date_time_booked`,`no_of_passengers`,`no_of_baggage`,`message` FROM `transport_booking` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `transport_booking` (`transport`,`visitor`,`date`,`time`,`date_time_booked`,`no_of_passengers`,`no_of_baggage`,`message`) VALUES  ('"
                . $this->transport . "','"
                . $this->visitor . "','"
                . $this->date . "','"
                . $this->time . "','"
