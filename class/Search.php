...
class Search {
    ...
    public function GetTransportBySelfDrive($from, $type, $condition, $passengers, $pageLimit, $setLimit) {
    ...
    public function showPaginationSelfDrive($from, $type, $condition, $passengers, $per_page, $page) {
        ...
        $page_url = "?";
        $query = "SELECT COUNT(*) as totalCount FROM `transports` INNER JOIN rent_a_car ON transports.id = rent_a_car.transport LEFT OUTER JOIN member on transports.member=member.id $where";
