...
//        }
        ...
        if ($RESULT) {
            ...
            $visitor_image_name = $VISITOR->image_name;
            ...
            $subject = $visitor_f_name . ' ' . $visitor_l_name . ' send a new message to you';
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="border-collapse:collapse;min-width:100%" width="400" valign="top">
                                                                                                                        <div style="line-height:20px;color:#888;text-align:left;font-size:13px!important;color:rgba(0,0,0,0.8)">
                                                                                                                            ...
                                                                                                                            <span style="font-weight:bold;font-size:15px;opacity:0.8"> ' . $visitor_f_name . ' ' . $visitor_l_name . ' sent a new message. </span>
                                                                                                                            <br>
