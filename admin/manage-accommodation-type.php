                                        ...
                                        <tbody>
                                            ...
                                            foreach ($ACCOMODATION_TYPE->all() as $key => $accommodation_type) {
                                                ...
                                                <tr id="row_<?php echo $accommodation_type['id']; ?>">
                                                    ...
                                                    <td> 
                                                        <a href="edit-accommodation-type.php?id=<?php echo $accommodation_type['id']; ?>" class="op-link"><i class="glyphicon glyphicon-pencil"></i></a>  |  

                                                        <a href="#" class="delete-accommodation-type" data-id="<?php echo $accommodation_type['id']; ?>">
