...
<html> 
    <head>
        ...
        <title>Arrange Accommodation Photos - www.srilankatourism.travel</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Accommodation photos</h2>
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/accommodation-photos.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($ACCOMODATION_PHOTO) > 0) {
                                                        foreach ($ACCOMODATION_PHOTO as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/accommodation/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
