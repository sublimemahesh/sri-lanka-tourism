...
$ARTICLE_PHOTO = ArticlePhoto::getArticlePhotosById($id);
?>
<!DOCTYPE html>
<html> 
    <head>
        ...
        <title>Arrange Article Photos - www.srilankatourism.travel</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Article Photos</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="view-article-photos.php?id=<?php echo $id ?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/article_photo.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($ARTICLE_PHOTO) > 0) {
                                                        foreach ($ARTICLE_PHOTO as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/article/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
