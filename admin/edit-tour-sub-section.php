...
<html> 
    <head>
        ...
        <title>Edit tour itinerary - www.srilankatourism.travel</title>
        <!-- Favicon-->
                                ...
                                <form class="form-horizontal" method="post" action="post-and-get/tour-sub-section.php" enctype="multipart/form-data"> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <textarea id="description" name="description" class="form-control" rows="5"><?php echo $TOUR_SUB->description; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            ...
                                            <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="edit-tour-sub-section" value="update">Save Changes</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
