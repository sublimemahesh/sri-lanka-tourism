                                ...
                                <form class="form-horizontal col-sm-9 col-md-9" method="post" action="post-and-get/room-facility.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">                                       
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="file" id="image" class="form-control" value="<?php echo $ROOM_FACILITY->image_name; ?>"  name="image">
                                                    <img src="../upload/room-facility-icons/<?php echo $ROOM_FACILITY->image_name; ?>" id="image" class="view-edit-img img img-responsive img-thumbnail" name="image" style="width: 10%"alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            <input type="hidden" id="oldImageName" value="<?php echo $ROOM_FACILITY->image_name; ?>" name="oldImageName"/>
