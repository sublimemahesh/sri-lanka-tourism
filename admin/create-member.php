                                ...
                                <form class="form-horizontal"  method="post" action="post-and-get/member.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="contact" class="form-control" placeholder="Enter contact number" autocomplete="off" name="contact" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5"> 
                                            <input type="submit" name="add-user" class="btn btn-primary m-t-15 waves-effect" value="Add user"/>
                                        </div>
                                    </div>
                                    <hr/>
                                </form>
