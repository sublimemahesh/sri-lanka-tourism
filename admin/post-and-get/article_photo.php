...
if (isset($_POST['create'])) {
    ...
    $ARTICLE_PHOTO->article = $_POST['id'];
    $ARTICLE_PHOTO->caption = $_POST['caption'];

    $dir_dest = '../../upload/article/';
    $dir_dest_thumb = '../../upload/article/thumb/';
    ...
    $ARTICLE_PHOTO->image_name = $imgName;

    $VALID->check($ARTICLE_PHOTO, [
        'image_name' => ['required' => TRUE],
        'caption' => ['required' => TRUE]
    ]);

    if ($VALID->passed()) {
        $ARTICLE_PHOTO->create();
...
if (isset($_POST['update'])) {
    ...
    $ARTICLE_PHOTO->image_name = $_POST['oldImageName'];
    $ARTICLE_PHOTO->caption = $_POST['caption'];
...
if (isset($_POST['arrange-data'])) {
    ...
    foreach ($_POST['sort'] as $key => $img) {
        ...
        $ARTICLE_PHOTO = ArticlePhoto::arrange($key, $img);
