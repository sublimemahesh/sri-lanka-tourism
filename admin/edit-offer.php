...
<html> 
    ...
    <body class="theme-red">
                                ...
                                <form class="form-horizontal" method="post" action="post-and-get/offer.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="title" class="form-control" placeholder="Enter Member name" autocomplete="off" name="title" required="TRUE" value="<?php echo $OFFER->title; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="url" class="form-control" placeholder="Enter Email" autocomplete="off" name="url" required="TRUE" value="<?php echo $OFFER->url; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="file" id="image_name" class="form-control" name="image" value="<?php echo $OFFER->image_name; ?>">
                                                    <img src="../upload/offer/<?php echo $OFFER->image_name; ?>" id="image" class="view-edit-img img img-responsive img-thumbnail" name="image_name" alt="old image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!--                                            <input type="hidden" id="authToken" value="<?php echo $_SESSION["authToken"]; ?>" name="authToken"/>-->
                                                <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="update-offer" value="update">Save Changes</button>
                                            </div>
                                        </div>
