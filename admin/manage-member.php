                                        ...
                                        <tbody>
                                            ...
                                            foreach ($MEMBER->all() as $key => $member) {
                                                ...
                                                <tr id="row_<?php echo $member['id']; ?>">
                                                    ...
                                                    <td> 
                                                        <a href="edit-member.php?id=<?php echo $member['id']; ?>" class="op-link"><i class="glyphicon glyphicon-pencil"></i></a>  |  

                                                        <a href="#" class="delete-member" data-id="<?php echo $member['id']; ?>">
