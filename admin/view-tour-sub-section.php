                                        ...
                                        foreach ($TOUR_SUB as $key => $tour_s) {
                                            ...
                                            <div class="col-md-3" id="div_<?php echo $tour_s['id']; ?>">
                                                <div class="img-caption">
                                                    ...
                                                    <div class="d">
                                                        <a href="#"> <button class="glyphicon glyphicon-trash delete-btn delete-tour-sub-section" data-id="<?php echo $tour_s['id']; ?>"></button></a>
                                                        <a href="edit-tour-sub-section.php?id=<?php echo $tour_s['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a>
                                                        <a href="arrange-tour-sub-section.php?id=<?php echo $id; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
