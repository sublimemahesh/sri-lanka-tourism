...
<html> 
    <head>
        ...
        <title>Add New Visitor - www.srilankatourism.travel</title>
        <!-- Favicon-->
                                ...
                                <form class="form-horizontal"  method="post" action="post-and-get/visitor.php" enctype="multipart/form-data"> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="name" class="form-control" placeholder="Enter Visitor name" autocomplete="off" name="name" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5"> 
                                            <input type="submit" name="add-visitor" class="btn btn-primary m-t-15 waves-effect" value="Add Visitor"/>
                                        </div>
                                    </div>
                                    <hr/>
                                </form>
