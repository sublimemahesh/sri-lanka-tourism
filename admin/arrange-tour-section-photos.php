...
<html> 
    <head>
        ...
        <title>Arrange Tour Section Photo - www.srilankatourism.travel</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Tour Section Photo</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="view-tour-sub-section-photos.php?id=<?php echo $id ?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/tour-sub-section-photo.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($TOUR_SUB_PHOTO) > 0) {
                                                        foreach ($TOUR_SUB_PHOTO as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/tour-package/sub-section/gallery/<?php echo $img["image_name"]; ?>" alt=""/>
