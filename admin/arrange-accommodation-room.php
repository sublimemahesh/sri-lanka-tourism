...
<html> 
    <head>
        ...
        <title>Arrange Accommodation Rooms - www.srilankatourism.travel</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Accommodation Rooms</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="create-accommodation-rooms.php?id=<?php echo $id;?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/accommodation-rooms.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($ACCOMODATION_ROOM) > 0) {
                                                        foreach ($ACCOMODATION_ROOM as $key => $img) {
                                                            ?>
