                                    ...
                                    if ($type == 'all') {
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade in active" id="taxi" name="taxi" role="tabpanel">
                                                <?php
                                                $SEARCHDETAILS = $SEARCH->searchByKeywordAndType($keyword, 'taxi');
                                                if ($SEARCHDETAILS) {
...
//                                                                            }
                                    ...
                                    <!--                                                        <span class="brackets">(Based on 17 reviews)</span>-->
                                                    ...
                                                    ?>
                                                    <div class="row">
                                                        <h4>No related data in the database.</h4>
                                                    </div>
                                                    <?php
                                                }
                                                ?>
                                                    ...
                                                    foreach ($SEARCHDETAILS as $accommodation) {
                                                        ...
                                                        <div class="room">
                                                            <a target="blank" href="accommodation-view.php?id=<?php echo $accommodation['id']; ?>" class="">
                                                                <div class="ribbon1 ribbon-top-left"><span><?php echo $accommodation['name']; ?></span>
                                                                </div>
                                                                <!--ROOM IMAGE-->
                                                                <div class="r1 r-com">
                                                                    <?php
...
//                                                                            }
                                            ...
                                            <div class="tab-pane fade" id="articles" name="articles" role="tabpanel">
                                                <?php
                                                $SEARCHDETAILS = $SEARCH->searchByKeywordAndType($keyword, 'article');
                                                if ($SEARCHDETAILS) {
                                                    foreach ($SEARCHDETAILS as $ARTICLE) {
                                                        ...
                                                        ?>
                                                        <div class="tour-pack1 col-md-4 col-sm-4">
